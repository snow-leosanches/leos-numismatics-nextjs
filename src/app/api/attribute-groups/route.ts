...
export async function GET(request: Request) {
  ...
  // attributes: comma-separated list of attribute names (required for getGroupAttributes)
  ...
  // getGroupAttributes requires version
  ...
  try {
    ...
    const groupAttributes = await signals.getGroupAttributes({
    ...
    return NextResponse.json(groupAttributes);
  } catch (error) {
    const errorMessage =
      error instanceof Error ? error.message : String(error);
